...
public class UpdateManager_Sql_Tests : IClassFixture<MultipleSqlServerDatabaseFixture>
{
    ...
    public UpdateManager_Sql_Tests(ITestOutputHelper output, MultipleSqlServerDatabaseFixture fixture)
    {
